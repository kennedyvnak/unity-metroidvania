...
namespace Metroidvania
{
    ...
    public struct GizmosDrawer
    {
        ...
        private readonly struct HandlesDrawingScope : IDisposable
        {
            ...
            public void Dispose()
            {
                if (_back) Handles.color = _oldColor;
            }
        }
        ...
        public GizmosDrawer DrawWireSquare(Vector2 center, Vector2 size)
        {
            ...
            var a = center + new Vector2(-vector2.x, -vector2.y);
            var b = center + new Vector2(vector2.x, -vector2.y);
            var c = center + new Vector2(vector2.x, vector2.y);
            var d = center + new Vector2(-vector2.x, vector2.y);
