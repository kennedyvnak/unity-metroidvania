...
namespace Metroidvania.InputSystem
{
    ...
    public class InputReader : ScriptableSingleton<InputReader>, InputActions.IGameplayActions, InputActions.IMenusActions
    {
        ...
        void InputActions.IMenusActions.OnTrackedDevicePosition(InputAction.CallbackContext context)
        {
        }

        void InputActions.IMenusActions.OnTrackedDeviceOrientation(InputAction.CallbackContext context)
        {
        }
    }
}