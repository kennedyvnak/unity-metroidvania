...
namespace Metroidvania.Combat
{
    ...
    {
        public static void CastEntityBoxHit(Vector2 position, Vector2 size, Collider2D[] hits, LayerMask playerLayer, float damage, Vector2 knockbackForce)
        {
            int hitsCount = Physics2D.OverlapBoxNonAlloc(position, size, 0, hits, playerLayer);
